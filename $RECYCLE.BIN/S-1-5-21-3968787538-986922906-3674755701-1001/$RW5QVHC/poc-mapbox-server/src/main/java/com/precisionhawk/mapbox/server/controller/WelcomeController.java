package com.precisionhawk.mapbox.server.controller;

import com.precisionhawk.mapbox.common.WelcomeMessage;
...
public class WelcomeController {
     ...
     * to the server at the sub-url of '/welcome' (e.g. http://localhost:8080/poc-mapbox-server/welcome)
